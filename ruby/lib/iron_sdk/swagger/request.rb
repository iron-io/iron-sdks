module IronSdk
  module Swagger
    class Request
      ...
      attr_accessor :host, :path, :format, :params, :body, :http_method, :headers, :form_params, :token

      # All requests must have an HTTP method and a path
      # Optionals parameters are :params, :headers, :body, :format, :host
      def initialize(http_method, path, host, attributes={})
        ...
        attributes[:headers].merge!({:Authorization => "OAuth " + attributes[:token]})
